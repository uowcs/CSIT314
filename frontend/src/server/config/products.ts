...
export const productCategories = [
  ...
  {
    title: "food",
    image: "/images/food-category.webp",
    subcategories: [
      {
        title: "Fruits",
        description: "Fresh and juicy fruits for a healthy snack.",
        slug: "fruits",
      },
      {
        title: "Vegetables",
        description: "Crisp and colorful vegetables for nutritious meals.",
        slug: "vegetables",
      },
      {
        title: "Breads & Cereals",
        description: "Wholesome breads and cereals for a hearty breakfast.",
        slug: "breads-cereals",
      },
      {
        title: "Meats",
        description: "High-quality meats for flavorful dishes.",
        slug: "meats",
      },
      {
        title: "Dairy",
